...
<head>
    ...
    <style>
        ...
        .d-flex #btn {
            border-radius: 30px; /* Keeps the rounded look */
            padding: 8px 15px; /* Adjusts padding for a smaller button */
            /* padding: 0px 15px; */
            margin-left: 20px;
    ...
    <div class="pen1">
        <form id="review-form" action="" method="POST">
            ...
            <fieldset>
                ...
                <textarea id="reviewtext" name="reviewtext" rows="5" required placeholder="Write your review here..."></textarea>

                <label for="name">Name:</label>
                <input type="text" id="name" name="name" placeholder="Your name (optional)" required><br>

                <label for="email">Email:</label>
                <input type="email" id="email" name="email" placeholder="Your email (optional)" required><br>

                <button type="submit" onclick="msg(event)">Submit Review</button>
            </fieldset>
        </form>
    </div>
    <!-- Review Form End -->
