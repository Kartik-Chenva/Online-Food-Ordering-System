...
td a[href^="delete_registration"] {
    background-color: #dc3545;
    border: 1px solid #c82333;
}

td a[href^="delete_registration"]:hover {
    background-color: #c82333;
    box-shadow: 0px 4px 6px rgba(220, 53, 69, 0.3);
}

/* Edit Button - Business Green */
td a[href^="edit_registration"] {
    background-color: #28a745;
    border: 1px solid #218838;
}

td a[href^="edit_registration"]:hover {
        ...
        <li>
            ...
            <div class="main--content">
                <div class="main_mrg">
                    <div class="overview" >
                        <div class="title">
                            <h2 class="section--title">Register Overview</h2>
                        </div>
                        <ul class="breadcrumb">
                            <li>
                        ...
                        <span class="icon icon-register"><i class='bx bxs-user-plus'></i><h5>Register Data</h5></span>
                    </div>
                    <div class="search">
                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>{{$user['email']}}</td>    
                            <!-- <td>{{$user['password']}}</td>     -->
                            <td><a href="delete_registration/{{$user['id']}}" onclick="return confirm('Are you sure you want to delete this registration?')">Delete</td>
                            <td><a href="edit_registration/{{$user['id']}}" onclick="return confirm('Are you sure you want to Edit this registration?')">Edit</td>
                        </tr>
                        @endforeach
                    </table>
