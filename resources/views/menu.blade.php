    ...
    <div class="top-section">
      ...
      <div class="row">
              <script>
                ...
                function checkLoginAndOrder(formId) {
                  if (isLoggedIn) {
              ...
              <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  <img src="{{ asset('images/burger.png') }}" alt="" style="margin-top: 10px;">
                  <div class="card-body">
                    <h1>Burger</h1>
                    <h5>Price : ₹ 50</h5>
                    <div class="rating">
                    ...
                    <div class="addbut">
                      <form id="orderForm1" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                        @csrf
                        <input type="hidden" name="id" value="1">
                        <input type="hidden" name="name" value="Burger">
                        <input type="hidden" name="price" value="50">
                        <input type="hidden" name="image" value="{{ asset('images/burger.png') }}">
                      </form>
                      <button onclick="checkLoginAndOrder('orderForm1')" class="btn btn-primary">Add to Cart</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 py-3 py-md-0">
              <div class="card">
                <img src="{{ asset('images/big.jpg') }}" alt="Italian Burger" style="margin-top: 40px; margin-bottom: 20px;">
                <div class="card-body">
                  ...
                  <div class="addbut">
                    <form id="orderForm12" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                      @csrf
                      <input type="hidden" name="id" value="12">
                      <input type="hidden" name="name" value="Italian Burger">
                      <input type="hidden" name="price" value="170">
                      <input type="hidden" name="image" value="{{ asset('images/big.jpg') }}">
                    </form>
                    <button type="button" onclick="checkLoginAndOrder('orderForm12')" class="btn btn-primary">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-4 py-3 py-md-0">
              <div class="card">
                <img src="{{ asset('images/hhh.jpg') }}" alt="" style="margin-top: 55px; margin-bottom: 10px;">
                <div class="card-body">
                  <h1>Burger</h1>
                  <h5>Price : ₹ 100</h5>
                  <div class="rating">
                  ...
                  <div class="addbut">
                    <form id="orderForm9" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                      @csrf
                      <input type="hidden" name="id" value="9">
                      <input type="hidden" name="name" value="Burger">
                      <input type="hidden" name="price" value="100">
                      <input type="hidden" name="image" value="{{ asset('images/hhh.jpg') }}">
                    </form>
                    <button type="button" onclick="checkLoginAndOrder('orderForm9')" class="btn btn-primary">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  <img src="{{ asset('images/bug1.jpg') }}" alt="" style="margin-top: 40px; margin-bottom: 30px;">
                  <div class="card-body">
                    <h1>Burger</h1>
                    <h5>Price : ₹ 200</h5>
                    <div class="rating">
                    ...
                    <div class="addbut">
                      <form id="orderForm2" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                        @csrf
                        <input type="hidden" name="id" value="2">
                        <input type="hidden" name="name" value="Burger">
                        <input type="hidden" name="price" value="200">
                        <input type="hidden" name="image" value="{{ asset('images/bug1.jpg') }}">
                      </form>
                      <button onclick="checkLoginAndOrder('orderForm2')" class="btn btn-primary">Add to Cart</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  <img src="{{ asset('images/crispy_fried.png') }}" alt="">
                  <div class="card-body">
                    <h1>Crispy Fried</h1>
                    <h5>Price : ₹ 120</h5>
                    <div class="rating">
                    ...
                    <div class="addbut">
                      <form id="orderForm5" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                        @csrf
                        <input type="hidden" name="id" value="5">
                        <input type="hidden" name="name" value="Crispy Fried">
                        <input type="hidden" name="price" value="120">
                        <input type="hidden" name="image" value="{{ asset('images/crispy_fried.png') }}">
                      </form>
                      <button type="button" onclick="checkLoginAndOrder('orderForm5')" class="btn btn-primary">Add to Cart</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  <img src="{{ asset('images/Rice Dishe1.jpg') }}" alt="Rice Dish Image" style="margin-top: 50px;">
                  <div class="card-body">
                    <h1>Rice Dishe</h1>
                    <h5>Price: ₹ 180</h5>
                    <div class="rating">
                      <i class="fa-solid fa-star checked"></i><i class="fa-solid fa-star checked"></i>
                      <i class="fa-solid fa-star checked"></i><i class="fa-solid fa-star checked"></i>
                      <i class="fa-solid fa-star checked"></i>
                    </div>
                    <div class="addbut">
                      <form id="orderForm3" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                        @csrf
                        <input type="hidden" name="id" value="3">
                        <input type="hidden" name="name" value="Rice Dishe">
                        <input type="hidden" name="price" value="180">
                        <input type="hidden" name="image" value="{{ asset('images/Rice Dishe1.jpg') }}">
                      </form>
                      <button type="button" onclick="checkLoginAndOrder('orderForm3')" class="btn btn-primary">Add to Cart</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  <img src="{{ asset('images/sushi__japanese.png') }}" alt="">
                  <div class="card-body">
                    <h1>Sushi Japanese</h1>
                    <h5>Price : ₹ 150</h5>
                    <div class="rating">
                      <i class="fa-solid fa-star checked"></i>
                      <i class="fa-solid fa-star checked"></i>
                    ...
                    <div class="addbut">
                      <form id="orderForm6" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                        @csrf
                        <input type="hidden" name="id" value="6">
                        <input type="hidden" name="name" value="Sushi Japanese">
                        <input type="hidden" name="price" value="150">
                        <input type="hidden" name="image" value="{{ asset('images/sushi__japanese.png') }}">
                      </form>
                      <button type="button" onclick="checkLoginAndOrder('orderForm6')" class="btn btn-primary">Add to Cart</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  <img src="{{ asset('images/Pineapple_Fried_Rice.png') }}" alt="">
                  <div class="card-body">
                    <h1>Fried Rice</h1>
                    <h5>Price : ₹ 120</h5>
                    <div class="rating">
                    ...
                    <div class="addbut">
                      <form id="orderForm7" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                        @csrf
                        <input type="hidden" name="id" value="7">
                        <input type="hidden" name="name" value="Fried Rice">
                        <input type="hidden" name="price" value="120">
                        <input type="hidden" name="image" value="{{ asset('images/Pineapple_Fried_Rice.png') }}">
                      </form>
                      <button type="button" onclick="checkLoginAndOrder('orderForm7')" class="btn btn-primary">Add to Cart</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="addbut">
                      <form id="orderForm4" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                        @csrf
                        <input type="hidden" name="id" value="4">
                        <input type="hidden" name="name" value="Pizza">
                        <input type="hidden" name="price" value="90">
                        <input type="hidden" name="image" value="{{ asset('images/pizza.png') }}">
                      </form>
                      <button type="button" onclick="checkLoginAndOrder('orderForm4')" class="btn btn-primary">Add to Cart</button>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-4 py-3 py-md-0">
              <div class="card">
                <img src="{{ asset('images/download (6).jpg') }}" alt="">
                <div class="card-body">
                  <h1>Fast Food</h1>
                  <h5>Price : ₹ 250</h5>
                  <div class="rating">
                  ...
                  <div class="addbut">
                    <form id="orderForm10" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                      @csrf
                      <input type="hidden" name="id" value="10">
                      <input type="hidden" name="name" value="Fast Food">
                      <input type="hidden" name="price" value="250">
                      <input type="hidden" name="image" value="{{ asset('images/download (6).jpg') }}">
                    </form>
                    <button type="button" onclick="checkLoginAndOrder('orderForm10')" class="btn btn-primary">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4 py-3 py-md-0">
              <div class="card">
                <img src="{{ asset('images/Rice Dishe.jpg') }}" alt="" style="margin-top: 55px; margin-bottom: 10px;">
                <div class="card-body">
                  <h1>Rice Dishe</h1>
                  <h5>Price : ₹ 190</h5>
                  <div class="rating">
                  ...
                  <div class="addbut">
                    <form id="orderForm11" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                      @csrf
                      <input type="hidden" name="id" value="11">
                      <input type="hidden" name="name" value="Rice Dishe">
                      <input type="hidden" name="price" value="190">
                      <input type="hidden" name="image" value="{{ asset('images/Rice Dishe.jpg') }}">
                    </form>
                    <button type="button" onclick="checkLoginAndOrder('orderForm11')" class="btn btn-primary">Add to Cart</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 py-3 py-md-0">
              <div class="card">
                <img src="{{ asset('images/download.jpg') }}" alt="" style="margin-top: 40px;">
                <div class="card-body">
                  <h1>Pizza</h1>
                  <h5>Price : ₹ 170</h5>
                  <div class="rating">
                  ...
                  <div class="addbut">
                    <form id="orderForm12" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                      ...
                      <input type="hidden" name="name" value="Pizza">
                      <input type="hidden" name="price" value="170">
                      <input type="hidden" name="image" value="{{ asset('images/download.jpg') }}">
                    </form>
                    <button type="button" onclick="checkLoginAndOrder('orderForm12')" class="btn btn-primary">Add to Cart</button>
                  </div>
                </div>
             ...
             <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  <img src="{{ asset('images/bug2.jpg') }}" alt="">
                  <div class="card-body">
                    <h1>G Beef Steak</h1>
                    <h5>Price : ₹ 180</h5>
                    <div class="rating">
                    ...
                    <div class="addbut">
                      <form id="orderForm8" action="{{ route('cart.add') }}" method="POST" style="display: none;">
                        @csrf
                        <input type="hidden" name="id" value="8">
                        <input type="hidden" name="name" value="G Beef Steak">
                        <input type="hidden" name="price" value="180">
                        <input type="hidden" name="image" value="{{ asset('images/bug2.jpg') }}">
                      </form>
                      <button type="button" onclick="checkLoginAndOrder('orderForm8')" class="btn btn-primary">Add to Cart</button>
                    </div>
                  </div>
                </div>
              </div>
